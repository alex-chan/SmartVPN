...
class AutoVPNManager {
    ...
    func addVPNStatusObserver() {
        ...
        loadProviderManager { [unowned self] (manager) -> Void in
            if let manager = manager {
                ...
                NotificationCenter.default.addObserver(forName: NSNotification.Name.NEVPNStatusDidChange, object: manager.connection, queue: OperationQueue.main, using: { [unowned self] (_) -> Void in
    ...
    public func loadProviderManager(_ complete: @escaping (NETunnelProviderManager?) -> Void) {
        NETunnelProviderManager.loadAllFromPreferences { (managers, _) -> Void in
